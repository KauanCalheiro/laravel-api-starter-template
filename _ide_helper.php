...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
        ...
        {
            /** @var \App\Guards\JwtCustomGuard $instance */
            return $instance->logout($forceForever);
        }
        ...
        {
            //Method inherited from \Tymon\JWTAuth\JWTGuard 
            \App\Guards\JwtCustomGuard::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Tymon\JWTAuth\JWTGuard 
            \App\Guards\JwtCustomGuard::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Tymon\JWTAuth\JWTGuard 
            return \App\Guards\JwtCustomGuard::hasMacro($name);
        }
        ...
        {
            //Method inherited from \Tymon\JWTAuth\JWTGuard 
            \App\Guards\JwtCustomGuard::flushMacros();
        }
...
namespace Illuminate\Database\Eloquent\Relations {
    ...
    class Relation {
        /**
         * @see \AaronFrancis\FastPaginate\RelationMixin::fastPaginate()
         * @param mixed $perPage
         * @param mixed $columns
        ...
        /**
         * @see \AaronFrancis\FastPaginate\RelationMixin::simpleFastPaginate()
         * @param mixed $perPage
         * @param mixed $columns
         * @param mixed $pageName
         * @param mixed $page
...
namespace Illuminate\Database\Query {
    ...
    class Builder {
        ...
        public static function jsonPaginate($maxResults = null, $defaultSize = null, $totalResults = null)
        {
            return \Illuminate\Database\Query\Builder::jsonPaginate($maxResults, $defaultSize, $totalResults);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        public static function jsonPaginate($maxResults = null, $defaultSize = null, $totalResults = null)
        {
            return \Illuminate\Database\Eloquent\Builder::jsonPaginate($maxResults, $defaultSize, $totalResults);
        }
