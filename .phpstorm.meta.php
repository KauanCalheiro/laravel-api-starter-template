...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Auth\Jwt\Contracts\ClaimsProvider' => \App\Auth\Jwt\Infrastructure\DefaultClaimsProvider::class,
            'App\Auth\Jwt\Contracts\TokenIssuer' => \App\Guards\JwtCustomGuard::class,
            'App\Auth\Jwt\Contracts\TokenRepository' => \App\Auth\Jwt\Infrastructure\EloquentTokenRepository::class,
            'App\Auth\Jwt\Contracts\TokenValidator' => \App\Auth\Jwt\Application\JwtTokenValidator::class,
            ...
            'Tymon\JWTAuth\Contracts\Providers\Storage' => \App\Providers\Storage\JwtBlacklistStorageProvider::class,
            'auth' => \Illuminate\Auth\AuthManager::class,
            'auth.driver' => \App\Guards\JwtCustomGuard::class,
            ...
            'tymon.jwt.provider.storage' => \App\Providers\Storage\JwtBlacklistStorageProvider::class,
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth_jwt.handlers.jwt','cache.default',
...
'database.connections.sqlsrv.prefix_indexes','database.connections.main.driver','database.connections.main.url','database.connections.main.host','database.connections.main.port',
'database.connections.main.database','database.connections.main.username','database.connections.main.password','database.connections.main.charset','database.connections.main.prefix',
'database.connections.main.prefix_indexes','database.connections.main.search_path','database.connections.main.sslmode','database.connections.testing.driver','database.connections.testing.database',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/kauan/Desktop/laravel-api-starter-template/public/storage','json-api-paginate.max_results','json-api-paginate.default_size',
...
'json-api-paginate.use_cursor_pagination','json-api-paginate.use_fast_pagination','json-api-paginate.base_url','json-api-paginate.pagination_parameter','jwt.secret',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.api','services.soap','session.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','telescope.hidden.response.parameters','telescope.hidden.request.parameters','telescope.hidden.request.headers',
...
'laravel-impersonate.leave_redirect_to','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name','activitylog.default_auth_driver',
...
'web','api',);
        registerArgumentsSet('routes', 'telescope','auth.login',
'auth.refresh','auth.register','auth.me','auth.impersonate','auth.unimpersonate',
...
'docs.scalar','telescope-login','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'validation.custom.attribute-name.rule-name','auth.unauthenticated','auth.logout.success','auth.login.success','auth.login.user_not_found',
'auth.login.failed','auth.login.failed_with_message','auth.refresh_token.invalid','auth.refresh_token.cannot_use','authorization.unauthorized',
'authorization.forbidden','authorization.role.assign.not_allowed','authorization.role.remove.strongest.not_allowed','authorization.role.not_found','database.unsupported.driver',
'impersonate.cannot.impersonate','impersonate.cannot.be_impersonated','impersonate.cannot.impersonate_yourself','impersonate.already_impersonating','impersonate.not_impersonating_anyone',
'impersonate.jwt_payload_missing','impersonate.impersonation_data_missing','impersonate.impersonator_not_found','impersonate.auth_user_not_found','mail.success',
'mail.failed.default','mail.failed.invalid_email','mail.failed.missing_subject','mail.failed.missing_message','mail.failed.missing_to',
'mail.failed.missing_from','mail.failed.invalid_attachment_format.name','mail.failed.invalid_attachment_format.type','mail.failed.invalid_attachment_format.mime_type','mail.failed.invalid_attachment_format.data',
'model.relation.not_found','model.value.not_found','model.name.country','model.name.state','model.name.city',
'model.name.action','model.name.action_planning','model.name.extension_project','model.name.extension_program','policy.responses.deny.view',
'policy.responses.deny.create','policy.responses.deny.update','policy.responses.deny.delete','query-builder.filters.scope_allowed.missing_scope','query-builder.includes.role_list.invalid',
'route.error.not_found','validation.phone_number','validation.empty_parameters','validation.custom.args_count','validation.must_be',
'passwords.password','validation.attributes.address','validation.attributes.age','validation.attributes.body','validation.attributes.cell',
'validation.attributes.city','validation.attributes.country','validation.attributes.date','validation.attributes.day','validation.attributes.excerpt',
'validation.attributes.first_name','validation.attributes.gender','validation.attributes.marital_status','validation.attributes.profession','validation.attributes.nationality',
...
'validation.attributes.birth_date',);
