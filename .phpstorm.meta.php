    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Tymon\JWTAuth\Contracts\Providers\Storage' => \Kamoca\JwtDatabaseBlacklist\Providers\Storage\Illuminate::class,
            ...
            'tymon.jwt.provider.storage' => \Kamoca\JwtDatabaseBlacklist\Providers\Storage\Illuminate::class,
    ...
    override(\config(), map([
            ...
            'database.connections.main.driver' => 'string',
            'database.connections.main.url' => 'NULL',
            'database.connections.main.host' => 'string',
            'database.connections.main.port' => 'string',
            'database.connections.main.database' => 'string',
            'database.connections.main.username' => 'string',
            'database.connections.main.password' => 'string',
            'database.connections.main.charset' => 'string',
            'database.connections.main.prefix' => 'string',
            'database.connections.main.prefix_indexes' => 'boolean',
            'database.connections.main.search_path' => 'string',
            'database.connections.main.sslmode' => 'string',
            ...
            'filesystems.links./home/kauan/Desktop/laravel-api-starter-template/public/storage' => 'string',
            ...
            'telescope.hidden.response.parameters' => 'array',
            'telescope.hidden.request.parameters' => 'array',
            'telescope.hidden.request.headers' => 'array',
...
'delete','assignRoles','revokeRoles','syncRoles',);
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.health_route',
...
'database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.main.driver','database.connections.main.url',
'database.connections.main.host','database.connections.main.port','database.connections.main.database','database.connections.main.username','database.connections.main.password',
'database.connections.main.charset','database.connections.main.prefix','database.connections.main.prefix_indexes','database.connections.main.search_path','database.connections.main.sslmode',
'database.connections.testing.driver','database.connections.testing.database','database.connections.testing.prefix','database.connections.testing.foreign_key_constraints','database.migrations.table',
...
'filesystems.disks.s3.throw','filesystems.links./home/kauan/Desktop/laravel-api-starter-template/public/storage','json-api-paginate.max_results','json-api-paginate.default_size','json-api-paginate.number_parameter',
'json-api-paginate.size_parameter','json-api-paginate.cursor_parameter','json-api-paginate.method_name','json-api-paginate.use_simple_pagination','json-api-paginate.use_cursor_pagination',
'json-api-paginate.use_fast_pagination','json-api-paginate.base_url','json-api-paginate.pagination_parameter','jwt.secret','jwt.keys.public',
...
'services.api','services.soap','session.driver','session.lifetime','session.expire_on_close',
...
'telescope.hidden.response.parameters','telescope.hidden.request.parameters','telescope.hidden.request.headers','laravel-impersonate.session_key','laravel-impersonate.session_guard',
'laravel-impersonate.session_guard_using','laravel-impersonate.default_impersonator_guard','laravel-impersonate.take_redirect_to','laravel-impersonate.leave_redirect_to','activitylog.enabled',
...
'activitylog.table_name','activitylog.database_connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'auth.login','auth.register','auth.user','auth.impersonate','auth.unimpersonate',
'auth.logout','auth.active-role','user.index','user.store','user.show',
'user.update','user.destroy','user.roles.assign','user.roles.revoke','user.roles.sync','telescope.login.get','telescope.login.post','docs.scalar.index',
'docs.scalar.spec','storage.local',);
        registerArgumentsSet('views', 
'docs.scalar','telescope-login','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'auth.unauthenticated','auth.logout.success','auth.login.success','auth.login.user_not_found','auth.login.failed',
'auth.login.failed_with_message','authorization.unauthorized','authorization.forbidden','authorization.role.assign.not_allowed','authorization.role.remove.strongest.not_allowed',
'authorization.role.not_found','database.unsupported.driver','impersonate.cannot.impersonate','impersonate.cannot.be_impersonated','impersonate.cannot.impersonate_yourself',
'impersonate.already_impersonating','impersonate.not_impersonating_anyone','impersonate.jwt_payload_missing','impersonate.impersonation_data_missing','impersonate.impersonator_not_found',
'impersonate.auth_user_not_found','mail.success','mail.failed.default','mail.failed.invalid_email','mail.failed.missing_subject',
'mail.failed.missing_message','mail.failed.missing_to','mail.failed.missing_from','mail.failed.invalid_attachment_format.name','mail.failed.invalid_attachment_format.type',
'mail.failed.invalid_attachment_format.mime_type','mail.failed.invalid_attachment_format.data','model.relation.not_found','model.value.not_found','model.name.country',
'model.name.state','model.name.city','model.name.action','model.name.action_planning','model.name.extension_project',
'model.name.extension_program','policy.responses.deny.view','policy.responses.deny.create','policy.responses.deny.update','policy.responses.deny.delete',
'query-builder.filters.scope_allowed.missing_scope','query-builder.includes.role_list.invalid','route.error.not_found','validation.phone_number','validation.empty_parameters',
'validation.custom.args_count','validation.must_be','passwords.password','validation.attributes.address','validation.attributes.age',
'validation.attributes.body','validation.attributes.cell','validation.attributes.city','validation.attributes.country','validation.attributes.date',
'validation.attributes.day','validation.attributes.excerpt','validation.attributes.first_name','validation.attributes.gender','validation.attributes.marital_status',
'validation.attributes.profession','validation.attributes.nationality','validation.attributes.hour','validation.attributes.last_name','validation.attributes.message',
'validation.attributes.minute','validation.attributes.mobile','validation.attributes.month','validation.attributes.name','validation.attributes.zipcode',
'validation.attributes.company_name','validation.attributes.neighborhood','validation.attributes.number','validation.attributes.password','validation.attributes.phone',
'validation.attributes.second','validation.attributes.sex','validation.attributes.state','validation.attributes.street','validation.attributes.subject',
...
'validation.attributes.description','validation.attributes.password_confirmation','validation.attributes.current_password','validation.attributes.complement','validation.attributes.modality',
'validation.attributes.category','validation.attributes.blood_type','validation.attributes.birth_date',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','VITE_APP_NAME','MASTER_PASSWORD',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_USERNAME','DB_PASSWORD',
'MAIL_MAILER','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','JWT_SECRET',);
